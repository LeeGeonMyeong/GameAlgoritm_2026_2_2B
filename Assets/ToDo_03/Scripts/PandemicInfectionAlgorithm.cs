...
namespace AlgoCourse.StudentWork
{
    public sealed class PandemicInfectionAlgorithm : ICityInfectionAlgorithm
    {
        ...
        private readonly Dictionary<int, int> infectionLevels = new Dictionary<int, int>(); //각 도시 변호별 현재 감염 단계를 저장합니다.
        ...
        public bool QueueInfection(int cityId)                  //지정한 도시를 감염 처리 대기 큐에 추가
        {
            ...
            infectionQueue.Enqueue(cityId);                    //지정학 도시를 감염 처리 대기 큐의 마지막에 추가 합니다.
        ...
        public CityInfectionStep ProcessNext()
        {
            ...
            OutbreakCount++;                                //새로운 아웃브레이크가 발생 했으므로 천체 발생 횟수를 1 증가
